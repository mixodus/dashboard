                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="col-sm-6">
                          ...
                          <input class="form-control" name="event_time" type="time" placeholder="Input time">
                        </div>
                        <div class="col-sm-6">
                          <label><b>Event Charge :</b></label>
                          <input class="form-control" name="event_charge" type="text" placeholder="Input charge">
                        </div>
                      </div>
                      </br>
                      <div class="row">
                      <div class="col-sm-6">
                          ...
                          <input class="form-control" name="event_longitude" type="text" placeholder="Input longtitude">
                        </div>
                        <div class="col-sm-6">
                          <label><b>Event Latitude :</b></label>
                          <input class="form-control" name="event_latitude" type="text" placeholder="Input latitude">
                        </div>
                      </div>
                      </br>
                      <div class="row">
